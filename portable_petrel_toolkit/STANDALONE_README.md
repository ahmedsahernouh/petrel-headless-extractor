...
For binary seismic conversion, use `convert_zgy_to_segy.bat` and read `ZGY_TO_SEGY.md`. The core objective and remaining native-data gaps are in `BINARY_EXTRACTION_PURPOSE.md`.
