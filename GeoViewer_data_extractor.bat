@echo off
rem GeoViewer_data_extractor - Ahmed Saher Nouh / SaherLabs
...
echo.
set "APP_ROOT=%~dp0GeoViewer\"
if exist "%APP_ROOT%STANDALONE.txt" goto standalone
set "APP_ROOT=%~dp0"
if exist "%APP_ROOT%STANDALONE.txt" goto standalone
if exist "%~dp0GeoViewer" goto incomplete_standalone
...
rem   GeoViewer_data_extractor.bat "L:\path\Project.pet" "D:\Petrel_Extracts" inventory
