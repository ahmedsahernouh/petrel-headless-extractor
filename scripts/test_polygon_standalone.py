...
''',encoding='utf-8')
    ...
    command="import sys,unittest;sys.path.insert(0,sys.argv[1]);r=unittest.TextTestRunner().run(unittest.defaultTestLoader.loadTestsFromNames(['test_petrel_native_recovery','test_petrel_native_spatial_zero_gui','test_petrel_visual_report','test_project_seismic','test_petrel_binary_conversion','test_companion_large_files','test_petrel_progress','test_petrel_surface_export','test_geoviewer_release']));sys.exit(not r.wasSuccessful())"
